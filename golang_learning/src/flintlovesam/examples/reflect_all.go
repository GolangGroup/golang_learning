...
func GetMembers(i interface{}){
	...
	for{
		...
		if t.Kind()==reflect.Ptr{
			fmt.Println("t.Kind()==reflect.Ptr")
			//get the real element of the pointer pointing
			t = t.Elem()
...
func Test(t reflect.Type){
	if t.NumMethod()>0{
		...
		fmt.Println(t.Method(0).Func.String())//desc
...
func (s ss2)Method1(i int)string {return "struct method1"}
func (s *ss2)Method2(i int)string {return "struct method 2"}
...
func main(){
		...
		GetMembers(&sr{})
		fmt.Println("==========================================> sr struct")
		GetMembers(sr{})
		fmt.Println("==========================================> new(reflect.Type)")
